...
## Description 
---
This project uses MySql and Node through the command line to allow business owners to view and manage their departments, roles, and employees in order to organize and plan their business.
...
Clone the repo to your local machine and run an 'npm install' on the local folder to install the necessary dependencies.
